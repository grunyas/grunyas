...
if [[ "${START_PROXY}" == "1" ]]; then
  export GRUNYAS_SERVER_PORTS_WRITE_LISTEN_ADDR="${PROXY_HOST}:${PROXY_PORT}"
  export GRUNYAS_SERVER_PORTS_WRITE_SSL_MODE="never"
  export GRUNYAS_SERVER_PORTS_WRITE_POOL_MODE="session"
  export GRUNYAS_AUTH_USERNAME="${PGUSER}"
  export GRUNYAS_AUTH_PASSWORD="${PGPASSWORD}"
  export GRUNYAS_NODES_0_ID="primary-1"
  export GRUNYAS_NODES_0_HOST="${PGHOST}"
  export GRUNYAS_NODES_0_PORT="${PGPORT}"
  export GRUNYAS_NODES_0_DECLARED_ROLE="primary"
  export GRUNYAS_NODES_0_CONNECTION_USER="${PGUSER}"
  export GRUNYAS_NODES_0_CONNECTION_PASSWORD="${PGPASSWORD}"
  export GRUNYAS_NODES_0_CONNECTION_DATABASE="${PGDATABASE}"
  export GRUNYAS_NODES_0_CONNECTION_CONNECT_TIMEOUT_SECONDS="5"
  export GRUNYAS_NODES_0_POOL_MIN_CONNS="1"
  export GRUNYAS_NODES_0_POOL_MAX_CONNS="10"
  export GRUNYAS_PROBE_INTERVAL_MS="1000"
  export GRUNYAS_PROBE_LIVENESS_FAILURE_COUNT="3"
  export GRUNYAS_PROBE_LIVENESS_MAX_AGE_MS="5000"
  export GRUNYAS_PROBE_ROLE_MAX_AGE_MS="5000"
  export GRUNYAS_SERVER_STARTUP_PROBE_TIMEOUT_SECONDS="10"
